...
<div class="auth-page">
  ...
  <div class="auth-card">
    ...
    <form method="POST" action="index.php?page=register&step=2" novalidate>
      ...
      <button type="submit" class="btn btn-primary btn-block btn-lg" style="margin-top:22px;">
        Complete Registration →
      </button>
      <a href="index.php?page=register&step=1"
         class="btn btn-ghost btn-block" style="margin-top:10px;justify-content:center;">
        ← Back
      </a>
    </form>
    <?php endif; ?>
