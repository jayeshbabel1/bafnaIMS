...
<div class="auth-page" style="padding-top:40px;">
  <a href="index.php?page=login" class="back-btn"><?= icon('back',18) ?> Back to Login</a>

  <div class="step-label">Step <?= $step ?> of 2</div>
  ...
  <p class="auth-sub">Enter your account credentials and professional details.</p>

  <form method="POST" action="index.php?page=register&step=1" id="regForm1" novalidate>
    ...
    <div class="input-wrap">
      ...
      <div class="password-wrap">
        <input type="password" name="password" id="regPwd" class="input-field" placeholder="Min. 8 characters" required minlength="8"/>
    ...
    <div class="input-wrap">
      ...
      <input type="password" name="password_confirm" id="regPwdC" class="input-field" placeholder="Re-enter password" required/>
    </div>
    <div class="input-wrap">
  ...
  <h2 class="auth-title">Your profession</h2>
  <p class="auth-sub">Help us personalise your experience.</p>
  ...
  <form method="POST" action="index.php?page=register&step=2" novalidate>
    ...
    <div class="input-wrap">
      ...
      <label class="role-option <?= ($old['role'] ?? '') === $val ? 'selected' : '' ?>">
        ...
        <span class="role-check"><?= icon('check',12) ?></span>
        <span><?= h($label) ?></span>
      </label>
      <?php endforeach; ?>
    </div>
    ...
    <button type="submit" class="btn-primary" style="margin-top:24px;">Complete Registration →</button>
    <a href="index.php?page=register&step=1" class="btn-ghost" style="margin-top:10px;width:100%;justify-content:center;">← Back</a>
  </form>
  <?php endif; ?>
