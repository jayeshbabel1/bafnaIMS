  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <div id="dflStep1">
      ...
      <div style="display:flex;gap:10px;">
        <button type="button" class="btn btn-secondary btn-block" data-bs-dismiss="modal"><?= h(ui('btn_cancel', 'Cancel')) ?></button>
  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <form method="POST" action="index.php">
      ...
      <div class="form-group">
        <label class="form-label"><?= h(ui('form_device_name', 'Device Name')) ?></label>
      ...
      <div style="display:flex;gap:10px;margin-top:6px;">
        ...
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><?= h(ui('btn_cancel', 'Cancel')) ?></button>
      </div>
    </form>
    </div>
  </div>
