<?php
/**
 * admin/views/products.php — with full RBAC guards applied inline
 */
...
if (!empty($_GET['ajax_products'])) {
    ...
    ob_start();
    if (empty($products)): ?>
    <tr><td colspan="9" class="admin-table-empty">No products found.</td></tr>
    <?php else:
    ...
    <tr>
      ...
      <td>
        <div class="admin-table-actions">
          <?php if (adminCan('products.edit')): ?>
          <a href="index.php?page=product_edit&id=<?= $p['id'] ?>" class="btn-admin-secondary btn-admin-sm" title="Edit"><?= icon('edit',13) ?></a>
          <?php endif; ?>
  ...
  <table class="admin-table" id="adminProductsTable">
    <thead>
      <tr>
        ...
        <th class="sortable-th" data-col="name">Name <span class="sort-icon" id="si-name"><span class="si-up"></span><span class="si-down"></span></span></th>
        <th class="sortable-th" data-col="quarry_number">Quarry # <span class="sort-icon" id="si-quarry_number"><span class="si-up"></span><span class="si-down"></span></span></th>
        <th>Category</th>
        <th class="sortable-th" data-col="quantity_available">Qty Available <span class="sort-icon" id="si-quantity_available"><span class="si-up"></span><span class="si-down"></span></span></th>
        <th class="sortable-th" data-col="quantity_on_hold">Qty On Hold <span class="sort-icon" id="si-quantity_on_hold"><span class="si-up"></span><span class="si-down"></span></span></th>
        <th class="sortable-th" data-col="in_stock">Stock <span class="sort-icon" id="si-in_stock"><span class="si-up"></span><span class="si-down"></span></span></th>
        <th>Featured</th>
        <th>Actions</th>
      </tr>
    </thead>
