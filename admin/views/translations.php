...
$uiStrings = [
    ...
    'btn_save'            => ['Save', 'Buttons'],
    'btn_send'            => ['Send', 'Buttons'],
    'btn_continue'        => ['Continue', 'Buttons'],
    'btn_clear'           => ['Clear', 'Buttons'],
    'btn_remove'          => ['Remove', 'Buttons'],
    'btn_rename'          => ['Rename', 'Buttons'],
    'btn_view'            => ['View', 'Buttons'],
    'btn_download'        => ['Download', 'Buttons'],
    'btn_email'           => ['Email', 'Buttons'],
    'btn_go_back'         => ['Go Back', 'Buttons'],
    'btn_go_to_catalog'   => ['Go to Catalog', 'Buttons'],
    'btn_go_to_login'     => ['Go to Login', 'Buttons'],
    'btn_back_to_product' => ['Back to Product', 'Buttons'],
    'btn_add_products'    => ['Add Products', 'Buttons'],
    'btn_generate_pdf'    => ['Generate PDF', 'Buttons'],
    'btn_trust_this_device' => ['Trust This Device', 'Buttons'],
    'btn_forced_logout'     => ['Forced Logout', 'Buttons'],
    'btn_yes_forced_logout' => ['Yes, Forced Logout', 'Buttons'],
    'btn_update_client'     => ['Update Client', 'Buttons'],
    'btn_save_client'       => ['Save Client', 'Buttons'],
    'btn_update_password'   => ['Update Password', 'Buttons'],
    'btn_save_to_selection' => ['Save to Selection', 'Buttons'],
    'link_manage_devices'   => ['Manage all trusted devices →', 'Buttons'],
    'btn_yes'               => ['Yes', 'Buttons'],
    'btn_no'                => ['No', 'Buttons'],
    'btn_add_one'           => ['Add one', 'Buttons'],
    'filter_filters'        => ['Filters', 'Filters'],
    'filter_all'            => ['All', 'Filters'],
    'filter_clear_all'      => ['Clear All', 'Filters'],
    'filter_apply_filters'  => ['Apply Filters', 'Filters'],
    'filter_min'            => ['Min', 'Filters'],
    'filter_max'            => ['Max', 'Filters'],
    'filter_stone_type'     => ['Stone Type', 'Filters'],
    'filter_color'          => ['Color', 'Filters'],
    'filter_available_sqft' => ['Available Sqft', 'Filters'],
    'filter_useable_length' => ['Useable Length (L)', 'Filters'],
    'filter_useable_height' => ['Useable Height (H)', 'Filters'],
    'filter_sort_latest'    => ['Latest', 'Filters'],
    'filter_sort_qty_desc'  => ['Qty: High→Low', 'Filters'],
    'filter_sort_qty_asc'   => ['Qty: Low→High', 'Filters'],
    'filter_sort_name_az'   => ['Name A→Z', 'Filters'],
    'filter_view_grid'      => ['Grid', 'Filters'],
    'filter_view_list'      => ['List', 'Filters'],
    'filter_view_table'     => ['Table', 'Filters'],
    'label_products'        => ['products', 'Filters'],
    'search_catalog_placeholder'   => ['Search by name or lot number…', 'Filters'],
    'search_clients_placeholder'   => ['Search by name, mobile or mason name…', 'Filters'],
    'search_selection_placeholder' => ['Search product name or lot number…', 'Filters'],
    'section_client_details'    => ['Client Details', 'Form Fields'],
    'section_mason_contractor'  => ['Mason / Contractor (Optional)', 'Form Fields'],
    'form_client'           => ['Client', 'Form Fields'],
    'form_client_name'      => ['Client Name', 'Form Fields'],
    'form_client_mobile'    => ['Client Mobile', 'Form Fields'],
    'form_email_address'    => ['Email Address', 'Form Fields'],
    'form_city'             => ['City', 'Form Fields'],
    'form_mason_name'       => ['Mason Name', 'Form Fields'],
    'form_mason_mobile'     => ['Mason Mobile', 'Form Fields'],
    'form_site_address'     => ['Site Address', 'Form Fields'],
    'form_full_name'        => ['Full Name', 'Form Fields'],
    'form_firm_studio'      => ['Firm / Studio', 'Form Fields'],
    'form_mobile'           => ['Mobile', 'Form Fields'],
    'form_current_password' => ['Current Password', 'Form Fields'],
    'form_new_password'     => ['New Password', 'Form Fields'],
    'form_device_name'      => ['Device Name', 'Form Fields'],
    'form_area_room'        => ['Area / Room', 'Form Fields'],
    'form_qty_required'     => ['Qty Required (sqft)', 'Form Fields'],
    'form_selection_area_room' => ['Selection Area / Room', 'Form Fields'],
    'form_quantity_required'   => ['Quantity Required (sqft)', 'Form Fields'],
    'form_notes'            => ['Notes', 'Form Fields'],
    'form_to'               => ['To', 'Form Fields'],
    'form_cc'               => ['CC', 'Form Fields'],
    'form_bcc'              => ['BCC', 'Form Fields'],
    'form_subject'          => ['Subject', 'Form Fields'],
    'form_message'          => ['Message', 'Form Fields'],
    'form_client_name_placeholder'   => ['e.g. Ramesh Patel', 'Form Fields'],
    'form_mobile_placeholder'        => ['98765 43210', 'Form Fields'],
    'form_email_placeholder'         => ['client@example.com', 'Form Fields'],
    'form_city_placeholder'          => ['e.g. Mumbai', 'Form Fields'],
    'form_mason_name_placeholder'    => ['e.g. Suresh Kumar', 'Form Fields'],
    'form_site_address_placeholder'  => ['Plot 12, Sector 5, New Mumbai — 400001', 'Form Fields'],
    'form_device_name_placeholder'   => ['Device name (e.g. My Laptop)', 'Form Fields'],
    'form_client_placeholder'        => ['Type to search client…', 'Form Fields'],
    'form_area_room_placeholder'     => ['e.g. Master Bedroom', 'Form Fields'],
    'form_notes_placeholder'         => ['Any special requirements…', 'Form Fields'],
    'form_notes_placeholder_product' => ['Special requirements, finish preferences…', 'Form Fields'],
    'form_cc_bcc_placeholder'        => ['optional, comma-separated', 'Form Fields'],
    'hint_mobile_10_digit' => ['10-digit Indian mobile number', 'Form Fields'],
    'hint_email_optional'  => ['Optional — used to send catalogs directly.', 'Form Fields'],
    'hint_min_8_chars'     => ['Min. 8 characters', 'Form Fields'],
    'label_characters'     => ['characters', 'Form Fields'],
    'title_edit_selection'        => ['Edit Selection', 'Form Fields'],
    'title_email_selection_pdf'   => ['Email Selection PDF', 'Form Fields'],
    'title_qty_exceeds_availability' => ['Quantity Exceeds Availability', 'Form Fields'],
    'msg_qty_exceeds_availability'   => ['Selected quantity is lower than available quantity. Do you still want to add this product?', 'Form Fields'],
